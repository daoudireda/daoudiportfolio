...
function changeHelloLanguage() {
  const helloTextElement = document.getElementById("helloText");
  currentIndex = (currentIndex + 1) % helloTranslations.length;
  helloTextElement.textContent = helloTranslations[currentIndex].text;
}

setInterval(changeHelloLanguage, 2000); // Change every 5 seconds
